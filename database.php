...
$db['default']['hostname'] = 'driver=SQL Server;server=DESKTOP-H7RQ38I\FEDY_SQL2008;uid=sa;pwd=edc;database=simakda_2017';
//$db['default']['hostname'] = 'simakda_2016';
$db['default']['username'] = '';
$db['default']['password'] = '';
$db['default']['database'] = 'simakda_2017';
