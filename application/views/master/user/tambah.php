    ...
    <table class="form">
        ...
        <tr>
            <td><label>jenis</label><br />
                ...
                <select name="jenis" id="jenis">
                    <option value="">......</option>
                    <option value="2">SIMAKDA SKPD</option>
                    <option value="1">SIMAKDA BUD</option>
                </select>
        ...
        <tr>
            <td>
                ...
                <a type='edit3' href="<?php echo site_url(); ?>/master/user"><i class="fa fa-arrow-left"></i> Kembali</a>
            </td>
        </tr>
    </table>
    <table class="narrow">
