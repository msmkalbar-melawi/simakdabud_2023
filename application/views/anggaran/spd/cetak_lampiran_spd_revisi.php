  ...
  <table id="rincian-spd">
    <thead>
      <tr>
        ...
        <th>JUMLAH SPD SEBELUM REVISI</th>
        <th>SISA ANGGARAN</th>
      </tr>
      <tr>
        <th>1</th>
    ...
    <tbody>
      ...
      <?php foreach ($rincian_spd as $key => $value) : ?>
        <tr>
          ...
          <?php if ($value['jenis'] == 'rekening') : ?>
            ...
            <?php $total_spd_pra_revisi += $value['nilai_pra_revisi'] ?>
          <?php else : ?>
          ...
          <td class="number<?php echo $value['jenis'] == 'rekening' ? '' : ' text-bold' ?>"><?php echo number_format($value['nilai_pra_revisi'], 2, ',', '.') ?></td>
      ...
      <tr>
        ...
        <td class="number text-bold"><?php echo number_format($total_spd_pra_revisi, 2, ',', '.') ?></td>
