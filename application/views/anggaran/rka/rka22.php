	...
	<div id="content">        
        ...
        <table class="narrow">
            ...
            <tr>
                ...
                <td>                     
                    <a href="<?php echo site_url(); ?>/rka/preview_rka22/<?php echo $skpd->kd_skpd; ?>"target='_blank'><img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a></td>
            </tr>
            <?php endforeach; ?>
        </table>
