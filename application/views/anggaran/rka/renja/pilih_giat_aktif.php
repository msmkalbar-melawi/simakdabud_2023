...
//				alert(skpd);
		...
		$('#giat').combogrid({  
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>/index.php/rka_penetapan/ld_giat_keg_renja_nonaktif/'+''+'/'+'',  
            columns:[[  
                {field:'kd_sub_kegiatan',title:'Kode Kegiatan',width:120},  
                {field:'nm_sub_kegiatan',title:'Nama Kegiatan',width:600},
      ...
      function validate_skpd(){
        ...
        function validate_giat(skpd){
			$('#giat').combogrid({  
            url:'<?php echo base_url(); ?>/index.php/rka_penetapan/ld_giat_keg_renja_nonaktif/'+skpd
            });
	...
	$("#dg").edatagrid("selectAll");
        ...
        jidx     = jrow + 1 ;			
            ...
            $('#dg').edatagrid('appendRow',{kd_sub_kegiatan:kode,id:jidx});
        }
        ...
        //alert(skpd+urusan);
            $(function(){
			$('#dg').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/rka_penetapan/select_giat_aktif_renja/'+skpd,
                 idField:'id',
                 toolbar:"#toolbar",              
                 rownumbers:"true", 
                 fitColumns:"true",
                 ...
                 columns:[[
					...
					{field:'kd_sub_kegiatan',
					 ...
					 editor:{type:"combobox",
      		                options:{valueField:'kd_sub_kegiatan',
									  textField:'kd_sub_kegiatan',
									  panelwidth:910,
									  url :'<?php echo base_url();?>/index.php/rka_penetapan/ld_giat_keg_renja_nonaktif/'+skpd,                        
									  required:true,
	...
	$(function(){
            ...
            //alert(skpd+urusan);
			$('#dg').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/rka_penetapan/select_giat_aktif_renja',
                 idField:'id',
                 toolbar:"#toolbar",              
                 rownumbers:"true", 
                 fitColumns:"true",
		...
		function getSelections(idx){
			...
			for(var i=0;i<rows.length;i++){
				ids.push(rows[i].kd_sub_kegiatan);
			}
			return ids.join(':');
		}
        ...
        //alert(urusan+skpd+baru+lama+jns);
            $(function(){
				$('#dg').edatagrid({
				     url: '<?php echo base_url(); ?>/index.php/rka_penetapan/psimpan_keg_aktif/'+skpd+'/'+baru,
					 idField:'id',
					 toolbar:"#toolbar",              
					 rownumbers:"true", 
					 fitColumns:"true",
       ...
       function aktifs(){		
        ...
        //alert(urusan+skpd+baru+lama+jns);
            $(function(){
				$('#dg').edatagrid({
				     url: '<?php echo base_url(); ?>/index.php/rka_penetapan/keg_renja_aktif_semua/'+skpd,
					 idField:'id',
					 toolbar:"#toolbar",              
					 rownumbers:"true", 
					 fitColumns:"true",
        ...
        function hapus(){
				...
				if  (del==true){
					$(function(){
						$('#dg').edatagrid({
							 url: '<?php echo base_url(); ?>/index.php/rka_penetapan/f_keg_nonaktif/'+skpd+'/'+rek,
							 idField:'id',
							 toolbar:"#toolbar",              
							 rownumbers:"true", 
							 fitColumns:"true",
        ...
        function hapus_semua(){
				...
				if  (del==true){
					$(function(){
						$('#dg').edatagrid({
							 url: '<?php echo base_url(); ?>/index.php/rka_penetapan/f_keg_nonaktif_semua/'+skpd,
							 idField:'id',
							 toolbar:"#toolbar",              
							 rownumbers:"true", 
							 fitColumns:"true",
