        ...
        alert(urusan+skpd+baru+lama+'-'+jns+'-'+lanjut);
            $(function(){
				$('#dg').edatagrid({
				     ...
				     queryParams: ({skpd:skpd,urusan:urusan,rekbaru:baru,reklama:lama,jenis:jns,lanjut:lanjut}),
					 idField:'id',
					 toolbar:"#toolbar",              
					 rownumbers:"true", 
					 fitColumns:"true",
...
<div id="content">   
 <!-- <?php echo $prev; ?>-->
  ...
  <h3>BIDANG URUSAN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="urusan" name="urusan" style="width: 100px;" />&nbsp;&nbsp;&nbsp;<input id="nm_urusan" name="nm_urusan" readonly="true" style="width:200px;border: 0;"/> </h3>
