       ...
       if ($giat !='' && $beban != '1'){
        ...
        if($beban=='3'){
            $sql = "SELECT DISTINCT c.no_sp2d,c.tgl_sp2d,c.nilai,
                    ...
                    WHERE c.kd_skpd = '$kode' AND c.status = 1 and c.tgl_kas<='$tgl' $where 
                    AND c.no_sp2d 
                    NOT IN (SELECT no_sp2d FROM trhlpj WHERE kd_skpd='$kode')ORDER BY c.tgl_sp2d DESC, c.no_sp2d";
        } else {
             $sql = "SELECT DISTINCT c.no_sp2d,c.tgl_sp2d,c.nilai,
                    0 as sisa                   
                    FROM trhspp a 
                    ...
                    INNER JOIN trhsp2d c ON b.no_spm=c.no_spm AND b.kd_skpd=c.kd_skpd
                    INNER JOIN trdspp d ON a.no_spp=d.no_spp AND a.kd_skpd=d.kd_skpd
                    WHERE left(c.kd_skpd,17) = '$kode' AND c.status = 1 and c.tgl_kas<='$tgl' $where ORDER BY c.tgl_sp2d DESC, c.no_sp2d";
        }
        $query1 = $this->db->query($sql);                  
        $result = array();
        $ii = 0;
        ...
        if ($jenis=='1'){
            $sql = "SELECT a.kd_rek6,a.nm_rek6,
					...
					SELECT SUM(nilai) FROM 
						...
						FROM trdrka a WHERE a.kd_sub_kegiatan= '$giat' AND a.kd_skpd = '$kode' $notIn  order by a.kd_rek6";
...
function load_total_spd(){
       ...
       $tgl    = $this->input->post('tgl');
        ...
        $sql1   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='1' and tgl_spd<='$tgl'" ;
        ...
        $sql2   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='2' and tgl_spd<='$tgl'" ;
        ...
        $sql3   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='3' and tgl_spd<='$tgl'" ;
        ...
        $sql4   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='4' and tgl_spd<='$tgl'" ;
        ...
        $sql5   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='5' and tgl_spd<='$tgl'" ;
        ...
        $sql6   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='6' and tgl_spd<='$tgl'" ;
        ...
        $sql7   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='7' and tgl_spd<='$tgl'" ;
        ...
        $sql8   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='8' and tgl_spd<='$tgl'" ;
        ...
        $sql9   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='9' and tgl_spd<='$tgl'" ;
        ...
        $sql10   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='10' and tgl_spd<='$tgl'" ;
        ...
        $sql11   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='11' and tgl_spd<='$tgl'" ;
        ...
        $sql12   = "SELECT max(revisi_ke) as revisi from trhspd where 
                                kd_skpd='$kode' 
                                and bulan_akhir='12' and tgl_spd<='$tgl'" ;
        ...
        $rev12   = $w12->revisi;
            ...
            $sql = "SELECT sum(nilai)as total_spd from (
                    ...
                    UNION ALL
                    SELECT
                    'W2' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W3' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W4' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W5' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W6' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W7' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W8' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W9' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W10' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W11' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
                    ...
                    UNION ALL
                    SELECT
                    'W12' ket,isnull(SUM(a.nilai),0) AS nilai
                    FROM
                    trdspd a
                    JOIN trhspd b ON a.no_spd = b.no_spd
                    WHERE
...
if ($sts_angkas=='murni'){
    ...
    $field_angkas='nilai_ubah5';
         ...
         if($jnsbeban==4 || substr($ckdkegi,5,10)=='01.1.02.01'){
            ...
            where a.kd_skpd = '$ckdskpd' and  a.kd_sub_kegiatan = '$ckdkegi' and a.kd_rek6='$kd_rek6' and (bulan <='$bulan1') GROUP BY a.kd_sub_kegiatan,a.kd_rek6
            ");
              
         }else{
            $query1   = $this->db->query(" SELECT  a.kd_sub_kegiatan, SUM(a.$field_angkas) as nilai FROM trdskpd_ro a INNER JOIN trskpd b ON a.kd_skpd=b.kd_skpd and a.kd_sub_kegiatan=b.kd_sub_kegiatan 
            where a.kd_skpd = '$ckdskpd' and  a.kd_sub_kegiatan = '$ckdkegi' and a.kd_rek6='$kd_rek6' and (bulan <='$bulan') GROUP BY a.kd_sub_kegiatan,a.kd_rek6
            ");    
         }
...
function load_total_angkas(){
       ...
       $tgl     = $this->input->post('tgl');
            ...
            $sql = "SELECT  a.kd_sub_kegiatan, SUM(a.nilai_ubah) as nilai FROM trdskpd_ro a INNER JOIN trskpd b ON a.kd_skpd=b.kd_skpd and a.kd_sub_kegiatan=b.kd_sub_kegiatan 
            where a.kd_skpd = '$kode' and  a.kd_sub_kegiatan = '$giat' and a.kd_rek6='$rek' and bulan <= month('$tgl') GROUP BY a.kd_sub_kegiatan,a.kd_rek6
            ";
...
function load_total_trans_spd(){ /*untuk transaksi konsep kota*/ 
...
function load_sisa_pot_ls(){
    ...
    function load_reksumber_dana() {                      
        ...
        $lccr   = $this->input->post('q');
            ...
            a.kd_sub_kegiatan='$giat' and a.kd_rek6='$rek' and a.kd_skpd='$kode' and nsumber2_ubah <> 0
            )z ";                
