    ...
    BELANJA SKPD </b>   
            ...
            $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"0\">
                            ...
                            <tr>
                                ...
                                <td colspan='3' style=\"border-right: solid 1px black;border-top: solid 1px black;\">:&nbsp; $capaian_prog</td>
  ...
  $cRet  .=" 
        ...
        $query = $this->db->query($qtriw);
            ...
            case 1;
                 ...
                 $this->support->_mpdf_margin('',$cRet,$kanan,$kiri,10,'1','',$atas,$bawah);
            break;
            case 2;        
    ...
    function preview_dpa_rincian_belanja_skpd_penetapan2(){
           ...
           $sqlttd1="SELECT nama as nm,nip as nip,jabatan as jab, pangkat as pangkat FROM ms_ttd WHERE kode in ('PA','KPA') AND(REPLACE(nip, ' ', 'a')='$ttd1' )  ";
            ...
            $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr> 
                             ...
                             <td width=\"20%\" style=\"vertical-align:top;\" rowspan=\"2\" align=\"center\"><strong><br /><br />FORMULIR <br /> DPA-RINCIAN
    BELANJA SKPD    
      </strong></td>
                        </tr>
                        <tr>
            ...
            $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"0\">
                            <tr>
                                <td width=\"20%\" style=\"vertical-align:top;border-right: none;\" align=\"left\">&nbsp;Nomor DPA</td>
                                <td width=\"5%\"  style=\"vertical-align:top;border-left: none;border-right: none;\" align=\"center\">:</td>
                                <td width=\"20%\" style=\"vertical-align:top;border-left: none;border-right: none;\" align=\"left\">$nodpa</td>
                     ...
                     // echo $subkeluaran;
                        ...
                        $cRet .= "<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\">
                            ...
                            <tr><td rowspan=\"2\"  width=\"10%\" align=\"center\"><b>Kode Rekening</b></td>                            
                                ...
                                <td rowspan=\"2\"  width=\"20%\" align=\"center\"><b>Jumlah(Rp.)</b></td></tr>
                            <tr>
                                <td width=\"9%\"     align=\"center\">Koefisien</td>
                                <td width=\"9%\"     align=\"center\">Satuan</td>
                                <td width=\"9%\"    align=\"center\">Harga</td>
                                <td width=\"3%\"     align=\"center\">PPN</td>
                            </tr>    
...
select 'Desember', isnull(sum(nilai),0) from trdskpd_ro where kd_skpd='$id' and bulan in ('12') and left(kd_sub_kegiatan,12)='$giat'
 ";
  ...
  $cRet  .=" 
                    <tr>
                                    <td style=\"border-right: solid 1px black;border-left: solid 1px black;border-top: solid 1px black;border-bottom: solid 1px black;\"  width=\"100%\" align=\"left\" colspan=\"3\">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Rencana Penarikan Dana per Bulan</td>
                                    <td rowspan=\"14\" width=\"100\" align=\"center\" colspan=\"1\">                          
        ...
        $query = $this->db->query($qtriw);
            foreach ($query->result() as $triw){
                            ...
                            $cRet  .=" 
                             <tr>
                                    <td width=\"20%\" style=\"border-left: solid 1px black;\" align=\"left\">&emsp;$bulan</td>
                    ...
                    $cRet  .="<tr>
                                    <td align=\"right\" style=\"border-left: solid 1px black;border-bottom: solid 1px black;\">&emsp;Jumlah</td>
                                    <td align=\"left\" style=\"border-right: none;border-bottom: solid 1px black;\">&emsp;Rp</td>                        
 ...
 ";
  ...
  $cRet  .=" 
        ...
        $query = $this->db->query($qtriw);
            ...
            $cRet    .= "</table>";
            $data['prev']= $cRet; 
            $judul ='DPA-Belanja-SKPD Penetapan'.$id.'';
          switch($cetak) { 
            case 1;
...
//NO DPA
            ...
            if (substr($id,18,4)=='0000'){
                $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"0\">
                        ...
                        <tr>
                            <td colspan=\"2\"\ align=\"center\"><strong>Ringkasan Dokumen Pelaksanaan Anggaran Pendapatan dan Belanja Daerah<br />
...
Satuan Kerja Perangkat Daerah</strong></td>
    ...
    GROUP BY a.kd_rek3, a.nm_rek3 ORDER BY kd_rek";
                    ...
                    foreach ($query->result() as $row)
                    {
                        ...
                        if(strlen($row->kd_rek)=='1'){
                         ...
                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"4%\" align=\"center\">".substr($coba1,4,2)."</td>                                     
                                         ...
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp$coba3</td></tr>";
                        ...
                        $cRet    .= " <tr><td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"3%\" align=\"center\">4</td>
                        <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"3%\" align=\"center\"></td>
                        <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"4%\" align=\"center\"></td>                                     
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"70%\">PENDAPATAN</td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp".number_format(0,"2",",",".")."</td></tr>";
                     ...
                     foreach ($sqlp->result() as $rowp)
                    {
                       $coba4=number_format($rowp->totp,"2",",",".");
                        ...
                        $cRet    .= " <tr><td colspan=\"3\" style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"center\"></td>                                     
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"70%\" align=\"right\"><b>Jumlah Pendapatan</b></td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp$coba4</td></tr>

                                      <tr><td colspan=\"3\" style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"left\"></td>                                     
    ...
    GROUP BY a.kd_rek3, a.nm_rek3 ORDER BY kd_rek";
                     ...
                     foreach ($query1->result() as $row1)
                    {
                        ...
                        if(strlen($row1->rek)=='1'){
                         ...
                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"4%\" align=\"center\">".substr($coba5,4,2)."</td>                                     
                                         ...
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp$coba7</td></tr>";
                     ...
                     foreach ($sqlb->result() as $rowb)
                    {
                       $coba8=number_format($rowb->totb,"2",",",".");
                        ...
                        $cRet    .= " <tr><td colspan=\"3\" style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"left\"></td>                                     
                                         ...
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp$coba8</td></tr>";
                     }
        ...
        $cRet    .= " <tr><td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"3%\" align=\"left\">6</td>  
                     ...
                     foreach ($sqltpm->result() as $rowtpm)
                    {
                       $coba12=number_format($rowtpm->totb,"2",",",".");
                        ...
                        $cRet    .= " <tr><td colspan=\"3\" style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"left\"></td>                                     
                                         ...
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp$coba12</td></tr>";
                     } 
    ...
    GROUP BY a.kd_rek3, a.nm_rek3 ORDER BY kd_rek";
                     ...
                     foreach ($querypk->result() as $rowpk)
                    {
                        ...
                        $coba11= number_format($rowpk->nilai,"2",",",".");
                         ...
                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"4%\" align=\"left\">".substr($coba9,4,2)."</td>                                    
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"70%\">$coba10</td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp$coba11</td></tr>";
                    } 
    ...
    $sqltpk="SELECT SUM(nilai) AS totb FROM trdrka WHERE LEFT(kd_rek6,2)='62' and kd_skpd='$id'";
          ...
          $pnetto=$cobtpm-$cobtpk;
                        $cRet    .= " <tr>                                     
                                         ...
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">Rp".$this->rka_model->angka($pnetto)."</td></tr></table>";                                                      
...
function load_pengesahan_dpa(){
        ...
        $sql = "SELECT a.*,b.nm_skpd from trhrka a LEFT JOIN ms_skpd b ON a.kd_skpd = b.kd_skpd ";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
        { 
            $murni  = $resulte['status'];
            $geser  = $resulte['status_sempurna'];
            $ubah   = $resulte['status_ubah'];
            $geser1 = $resulte['status_sempurna2'];
            ...
            $row[] = array(
                        ...
                        'sts_murni' => $status,
                        'sts_geser' => $status_geser,
                        'sts_ubah' => $status_perubahan,
                        'status_sempurna2' => $status_sempurna2
                        );
                        $ii++;
        }
...
<br>SKPD  </strong></td>
            ...
            if (substr($id,18,4)=='0000'){
                $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"0\">
                        ...
                        <tr>
                            <td colspan=\"2\"\ align=\"center\"><strong>Rincian Kerja Anggaran Pendapatan Satuan Kerja Perangkat Daerah</strong></td>
                        </tr>
                    </table>";
            }else{
                $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"0\">
...
Satuan Kerja Perangkat Daerah</strong></td>
    ...
    INNER JOIN ms_rek1 b ON LEFT(a.kd_rek6,1)=b.kd_rek1 WHERE LEFT(a.kd_rek6,1)='4' AND a.kd_skpd='$kode_skpd' GROUP BY LEFT(a.kd_rek6,1),nm_rek1 
    UNION ALL 
    SELECT LEFT(a.kd_rek6,2) AS rek1,LEFT(a.kd_rek6,2) AS rek,b.nm_rek2 AS nama, 0 AS volume,' 'AS satuan, 0 AS harga,SUM(a.nilai) AS nilai,'2' AS id FROM trdrka a INNER JOIN ms_rek2 b ON LEFT(a.kd_rek6,2)=b.kd_rek2 WHERE LEFT(a.kd_rek6,1)='4' AND a.kd_skpd='$kode_skpd' GROUP BY LEFT(a.kd_rek6,2),nm_rek2 
    UNION ALL 
    SELECT LEFT(a.kd_rek6,4) AS rek1,LEFT(a.kd_rek6,4) AS rek,b.nm_rek3 AS nama,0 AS volume,' 'AS satuan, 0 AS harga,SUM(a.nilai) AS nilai,'3' AS id FROM trdrka a INNER JOIN ms_rek3 b ON LEFT(a.kd_rek6,4)=b.kd_rek3 WHERE LEFT(a.kd_rek6,1)='4' AND a.kd_skpd='$kode_skpd' GROUP BY LEFT(a.kd_rek6,4),nm_rek3 
    UNION ALL 
    SELECT LEFT(a.kd_rek6,6) AS rek1,LEFT(a.kd_rek6,6) AS rek,b.nm_rek4 AS nama,0 AS volume,' 'AS satuan, 0 AS harga,SUM(a.nilai) AS nilai,'4' AS id FROM trdrka a INNER JOIN ms_rek4 b ON LEFT(a.kd_rek6,6)=b.kd_rek4 WHERE LEFT(a.kd_rek6,1)='4' AND a.kd_skpd='$kode_skpd' GROUP BY LEFT(a.kd_rek6,6),nm_rek4 
    UNION ALL 
    SELECT LEFT(a.kd_rek6,8) AS rek1,LEFT(a.kd_rek6,8) AS rek,b.nm_rek5 AS nama,0 AS volume,' 'AS satuan, 0 AS harga,SUM(a.nilai) AS nilai,'5' AS id FROM trdrka a INNER JOIN ms_rek5 b ON LEFT(a.kd_rek6,8)=b.kd_rek5 WHERE LEFT(a.kd_rek6,1)='4' AND a.kd_skpd='$kode_skpd' GROUP BY LEFT(a.kd_rek6,8),b.nm_rek5 
    UNION ALL 
    SELECT a.kd_rek6 AS rek1,a.kd_rek6 AS rek,b.nm_rek6 AS nama,0 AS volume,' 'AS satuan, 0 AS harga,SUM(a.nilai) AS nilai,'6' AS id FROM trdrka a INNER JOIN ms_rek6 b ON a.kd_rek6=b.kd_rek6 WHERE LEFT(a.kd_rek6,1)='4' AND a.kd_skpd='$kode_skpd' GROUP BY a.kd_rek6,b.nm_rek6 
    UNION ALL 
    
    SELECT RIGHT(a.no_trdrka,12)+ket_bl_teks AS rek1,' 'AS rek,a.uraian AS nama,a.volume1 AS volume,a.satuan1 AS satuan, a.harga AS harga,
    ...
    AND left(kd_rek6,1)='4' and header='0'  
                    ...
                    foreach ($query->result() as $row)
                    {
                     ...
                     $sqltp="SELECT SUM(nilai) AS totp FROM trdrka WHERE LEFT(kd_rek6,1)='4' AND kd_skpd='$kode_skpd'";
                        $sqlp=$this->db->query($sqltp);
                     foreach ($sqlp->result() as $rowp)
                    {
                       $totp=number_format($rowp->totp,"2",",",".");
                        ...
                        $cRet    .=" <tr><td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"left\">&nbsp;</td>                                     
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"40%\"><b>Jumlah Pendapatan<b/></td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"8%\">&nbsp;</td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"8%\">&nbsp;</td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"14%\" align=\"right\">&nbsp;</td>
                                         <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\"><b>$totp</td></b></tr>";
                     }
                    $kd_ttd=substr($id,18,4);
                     $kd_kepala=substr($id,0,7);
                    if (($kd_ttd=='0000')){
                        ...
                        <table style=\"border-collapse:collapse;font-size:10px\" width=\"100%\" align=\"left\" border=\"1\" cellspacing=\"2\" cellpadding=\"4\">
                                <tr>
                                    <td align=\"center\" colspan=\"2\"><b>Rencana Realisasi Penerimaan per Bulan</b></td>
                                    <td rowspan=\"15\" width=\"70%\" align=\"center\">$daerah ,$tanggal_ttd <br />$jabatan <br/> <br><br /><br /><br /><br/>
                                             <br/>$nama
                                    <br>$pangkat 
                                    <br>NIP. $nip
<br/><br/>
...
Satuan Kerja Perangkat Daerah</strong></td>
            ...
            $cRet .= "<table style=\"border-collapse:collapse; font-size:12;border-top: solid 1px black;\"  width=\"100%\" align=\"center\" border=\"1\"  cellspacing=\"0\" cellpadding=\"4\">
                    ...
                    foreach ($query->result() as $row)
                    {
                        ...
                        if (strlen($reke)>16 || strlen($reke)==0){
                           $cRet    .= "<tr>
