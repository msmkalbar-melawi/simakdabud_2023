    ...
    function tambah_rka_penyusunan()
        {
            ...
            $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" >
                       <tr >                       
                            <td align=\"center\"><h2>INPUT ANGGARAN PENYUSUNAN $jk</h2></td>
                            <td>$ry</td>
                            </tr>
                      ";
    ...
    function select_rka_rancang($kegiatan='',$skpd='') {
       ...
       function load_daftar_harga_detail_ck() {
            ...
            $reklancar   = substr($rekening,0,4);
                ...
                $sql    = "SELECT * from ms_standar_harga where (left(kd_rek6,2)='$rektetap' OR kd_rek6='' OR kd_rek6 is null OR kd_rek6='$rekening') and (upper(uraian_barang) like upper('%$cari%') or upper(spesifikasi) like upper('%$cari%')) order by id_standar_harga ";
            $query1 = $this->db->query($sql);  
            $result = array();
            $ii     = 0;
            foreach($query1->result_array() as $resulte)
...
function tsimpan_rinci_jk_rancang_temp(){
        ...
        $sql ="INSERT into trdpo_temp(header,kode,kd_barang,kd_rek6,no_po,no_trdrka,uraian,volume1,volume2,volume3,volume_sempurna1,volume_sempurna2,volume_sempurna3,volume_ubah1,volume_ubah2,volume_ubah3,satuan1,satuan2,satuan3,satuan_sempurna1,satuan_sempurna2,satuan_sempurna3,satuan_ubah1,satuan_ubah2,satuan_ubah3,harga1,harga_sempurna1,harga_ubah1,total,total_sempurna,total_ubah,unik,spesifikasi)
        values ('$header','$kode','$kd_barang','$kd_rek5','$no_po','$no_trdrka','$uraian','$volume1','$volume2','$volume3','$volume1_sempurna1','$volume1_sempurna2','$volume1_sempurna3','$volume_ubah1','$volume_ubah2','$volume_ubah3','$satuan1','$satuan2','$satuan3','$satuan_sempurna1','$satuan_sempurna2','$satuan_sempurna3','$satuan_ubah1','$satuan_ubah2','$satuan_ubah3','$harga1','$harga_sempurna1','$harga_ubah1','$total','$total_sempurna','$total_ubah','$kd_sisb','$spesifikasi')";
        $this->db->query($sql);
...
function hapus_rincian_temp(){
    ...
    function rka_rinci($skpd='',$kegiatan='',$rekening='') {
        ...
        echo json_encode($result);
         ...
         function rka_rinci_rancang_lama($skpd='',$kegiatan='',$rekening='') {
    ...
    function load_sum_rek_rancang(){
            ...
            $query1 = $this->db->query(" select sum(nilai) as rektotal,sum(nilai_sempurna) as rektotal_sempurna,sum(nilai_ubah) as rektotal_ubah from 
                                         trdrka_rancang where kd_skpd='$kdskpd' and kd_sub_kegiatan='$sub_kegiatan'");  
            $result = array();
            $ii = 0;
            foreach($query1->result_array() as $resulte)
            { 
    ...
    function rka22_penyusunan()
        {
         ...
         function preview_rka22_penyusunan(){
            ...
            $sql90="SELECT kd_skpd_90 FROM ms_skpd where left(kd_skpd,len('$id'))='$id'";
                     $sqls90=$this->db->query($sql90);
                     foreach ($sqls90->result() as $rows90)
                    {
                       
                        $kd_skpd_90=$rows90->kd_skpd_90;
                    }
            ...
            if (strlen($id)==17){          
                $cRet.="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"1\">
                       <tr>
                            ...
                            <td colspan=\"2\" style=\"vertical-align:left;border-left: none;\"> <strong>: ".substr($kd_skpd_90,0,(strlen($kd_skpd_90)-3))." - $nm_org</strong></td>
                        </tr>
                        <tr>
                ...
                $cRet.="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"1\">
                        ...
                        <tr>
                            <td width=\"20%\" style=\"vertical-align:center;border-right: none;\"><strong>&emsp;Organisasi</strong></td>
                            <td colspan=\"2\" style=\"vertical-align:center;border-left: none;\"> <strong>: ".substr($kd_skpd_90,0,(strlen($kd_skpd_90)-3))." - $nm_org</strong></td>
                        </tr> 
                        <tr>
                            <td width=\"20%\" style=\"vertical-align:center;border-right: none;\"><strong>&emsp;Unit Organisasi </strong></td>
                            <td colspan=\"2\"  style=\"vertical-align:center;border-left: none;\"><strong>: $kd_skpd_90 - $nm_skpd</strong></td>
                        </tr>
                        <tr>
                            <td colspan=\"3\" width=\"1%\" bgcolor=\"#CCCCCC\" align=\"center\" text-rotate=\"90\"><b>&nbsp;</b></td>
                        </tr>
    ...
    function cari221()
    {
        ...
        $this->index('0','ms_skpd','kd_skpd','nm_skpd','RKA 221','penyusunan/rka221',$lccr); 
    }
        ...
        {   
         ...
         function preview_rka221_penyusunan(){
           ...
           $sqlttd1="SELECT nama as nm,nip as nip,jabatan as jab, pangkat as pangkat FROM ms_ttd WHERE kd_skpd= '$id' AND kode in ('PA','KPA') AND(REPLACE(nip, ' ', 'a')='$ttd1' )  ";
            ...
            $sql90="SELECT kd_skpd as kd_skpd_90 FROM ms_skpd where kd_skpd='$id'";
                     $sqls90=$this->db->query($sql90);
                     foreach ($sqls90->result() as $rows90)
                    {
            ...
            $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr> 
                             <td width=\"60%\" align=\"center\"><strong>RENCANA KERJA DAN ANGGARAN <br> SATUAN KERJA PERANGKAT DAERAH </strong></td>
                             <td width=\"20%\" style=\"vertical-align:top;\" rowspan=\"4\" align=\"center\"><strong><br />Formulir <br /> RKA-RINCIAN
    BELANJA SKPD    
      </strong></td>
                        </tr>
                        ...
                        <tr>
                             <td style=\"vertical-align:top;\" align=\"center\">$kab TAHUN ANGGARAN $thn </td>
                        </tr>
            ...
            $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"0\">
                            ...
                            <tr>
                                ...
                                <td align=\"center\" style=\"vertical-align:top;border-left: none;border-right: none;\">:</td>
                                <td align=\"left\" style=\"vertical-align:top;border-left: none;border-right: none;\">".substr($kd_skpd_90,0,(strlen($kd_skpd_90)-3))."</td>
                                <td align=\"left\" style=\"vertical-align:top;border-left: none;\">$nm_skpd</td>
                            </tr>
                            <tr>
                                <td align=\"left\" style=\"vertical-align:top;border-right: none;\" align=\"left\">&nbsp;Unit</td>
                                <td align=\"center\" style=\"vertical-align:top;border-left: none;border-right: none;\">:</td>
                                <td align=\"left\" style=\"vertical-align:top;border-left: none;border-right: none;\">$kd_skpd_90</td>
                                <td align=\"left\" style=\"vertical-align:top;border-left: none;\">$nm_skpd</td>
                            </tr>
                            <tr>
            ...
            $cRet .=" <tr align=\"center\">
                        <td  width=\"20%\">Capaian Kegiatan </td>
                        <td  width=\"40%\" colspan=\"2\">$tu_capai</td>
                        <td  width=\"10%\" colspan=\"2\">$tk_capai</td>
                        
                     </tr>";
            $cRet .=" <tr align=\"center\">
                        <td  width=\"20%\">Masukan </td>
                        <td  width=\"40%\" colspan=\"2\">$tu_mas</td>
                        <td  width=\"40%\" colspan=\"2\">$tk_mas</td>
                        
                    </tr>";
            $cRet .=" <tr align=\"center\">
                        <td  width=\"20%\">Keluaran </td>
                        <td  width=\"40%\" colspan=\"2\">$tu_kel</td>
                        <td  width=\"40%\" colspan=\"2\">$tk_kel</td>
                        
                      </tr>";
            $cRet .=" <tr align=\"center\">
                        <td  width=\"20%\">Hasil </td>
                        <td  width=\"40%\" colspan=\"2\">$tu_has</td>
                        <td  width=\"40%\" colspan=\"2\">$tk_has</td>
                   ...
                   $sqlsub="SELECT a.kd_sub_kegiatan as kd_sub_kegiatan,b.nm_sub_kegiatan,b.sub_keluaran,b.lokasi,b.waktu_giat,b.waktu_giat2,b.keterangan FROM trdrka_rancang a
                    ...
                    if ($kdsumber2==''){
                        ...
                        $cRet .= "<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\">
                            ...
                            <tr>
                                <td width=\"8%\" bgcolor=\"#CCCCCC\" align=\"center\">Koefision</td>
                                <td width=\"8%\" bgcolor=\"#CCCCCC\" align=\"center\">Satuan</td>
                                <td width=\"14%\" bgcolor=\"#CCCCCC\" align=\"center\">harga</td>
                                <td width=\"14%\" bgcolor=\"#CCCCCC\" align=\"center\">PPN</td>
                            </tr>    
                           ...
                           <tr>
                            ...
                            $sql1="
    SELECT * FROM(
    -- SELECT 0 header,0 no_po, LEFT(a.kd_rek6,1)AS rek1,LEFT(a.kd_rek6,1)AS rek,b.nm_rek1 AS nama ,0 AS volume,' 'AS satuan,
    ...
    -- UNION ALL 
    SELECT 0 header, 0 no_po, LEFT(a.kd_rek6,8) AS rek1,RTRIM(LEFT(a.kd_rek6,8)) AS rek,b.nm_rek5 AS nama,''AS spek,0 AS volume,' 'AS satuan,
    ...
    UNION ALL
    SELECT 0 header, 0 no_po, a.kd_rek6 AS rek1,RTRIM(a.kd_rek6) AS rek,b.nm_rek6 AS nama,''AS spek,0 AS volume,' 'AS satuan,
    ...
    UNION ALL 
    SELECT * FROM (SELECT  b.header,b.no_po,RIGHT(a.no_trdrka,12) AS rek1,' 'AS rek,b.uraian AS nama,''AS spek,0 AS volume,' ' AS satuan,
    ...
    UNION ALL
    SELECT a. header,a.no_po,RIGHT(a.no_trdrka,12) AS rek1,' 'AS rek,a.uraian AS nama,a.spesifikasi AS spek,a.volume1 AS volume,a.satuan1 AS satuan,
    a.harga1 AS harga,a.total AS nilai,'8' AS id FROM trdpo_rancang a  WHERE LEFT(a.no_trdrka,22)='$id' AND SUBSTRING(no_trdrka,24,15)='$sub' AND (header='0' or header is null)
    ) a ORDER BY rek1,a.no_po
    ...
    ";
                    ...
                    $nilangsub=0;
                            ...
                            //    $volum=$row->volume;
                                ...
                                $volum= empty($row->volume) || $row->volume == 0 ? '' :number_format($row->volume);
                                ...
                                if ($row->id<'7'){
                                 ...
                                 $cRet    .= " <tr><td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"left\"><b>$reke</b></td>                                     
                                                 ...
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"8%\" align=\"right\"><b>$volum</b>&nbsp;&nbsp;&nbsp;</td>
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"8%\" align=\"center\"><b>$sat</b></td>
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"14%\" align=\"right\"><b>$hrg</b></td>
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\"><b>0</b></td>
                                                ...
                                                $cRet    .= " <tr><td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"left\"><b>$reke</b></td>                                     
                                                 ...
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"8%\" align=\"center\"><b>$sat</b></td>
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"14%\" align=\"right\"><b>$hrg</b></td>
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\"><b></b></td>
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\"><b>$nila</b></td></tr>
                                                 ";
                                             }else{
                                                $cRet    .= " <tr><td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"left\">$reke</td>                                     
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"40%\">&nbsp;&nbsp;$uraian <br>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Spesifikasi : $spek</td>
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"8%\" align=\"left\">$volum $sat&nbsp;&nbsp;&nbsp;</td>
                                                 ...
                                                 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"20%\" align=\"right\">0</td>
        ...
        function preview_rka0_penyusunan(){
            ...
            $sql90="SELECT kd_skpd_90 FROM ms_skpd where kd_skpd='$id'";
                     $sqls90=$this->db->query($sql90);
                     foreach ($sqls90->result() as $rows90)
                    {
     ...
     ON a.kd_urusan=b.kd_bidang_urusan WHERE  kd_skpd='$id'";
            ...
            $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"1\">
                        ...
                        <tr>
                            ...
                            <td width=\"80%\">".substr($kd_skpd_90,0,(strlen($kd_skpd_90)-3))." - ".$this->rka_model->get_nama($kd_org,'nm_org','ms_organisasi','left(kd_org,17)')."</td>
                        </tr>
                        <tr>
                            <td>Unit Organisasi</td>
                            <td>$kd_skpd_90 - $nm_skpd</td>
                        </tr>
                        <tr>
    ...
    $sqltpk="SELECT SUM(nilai) AS totb FROM trdrka_rancang WHERE LEFT(kd_rek6,2)='62' and kd_skpd='$id'";
         ...
         function preview_rka0_penyusunan_org(){
           ...
           $sqldns="SELECT a.kd_urusan as kd_u,left(b.kd_bidang_urusan,1) as header, LEFT(a.kd_skpd,17) as kd_org,
                    b.nm_bidang_urusan as nm_u,a.kd_skpd as kd_sk,
                    a.nm_skpd as nm_sk FROM ms_skpd a INNER JOIN ms_bidang_urusan b
            ...
            $sql90="SELECT kd_skpd_90 FROM ms_skpd where kd_skpd='$ids'";
            $query90=$this->db->query($sql90);
            foreach ($query90->result() as $rows90)
            {
                $kd_skpd_90=$rows90->kd_skpd_90;
            }
    ...
    $sqltpk="SELECT SUM(nilai) AS totb FROM trdrka_rancang WHERE LEFT(kd_rek6,2)='62' and LEFT(kd_skpd,17)='$id'";
        ...
        function urusan1(){
            ...
            $sql = "select a.kd_sub_kegiatan as kd_kegiatan,b.nm_sub_kegiatan,a.jns_kegiatan,a.lanjut,a.status_sub_kegiatan from trskpd_rancang a inner join ms_sub_kegiatan b on b.kd_sub_kegiatan=a.kd_sub_kegiatan where a.kd_skpd='$skpd' order by a.kd_sub_kegiatan";
            $query1 = $this->db->query($sql);  
            $result = array();
            $ii = 0;
            foreach($query1->result_array() as $resulte)
    ...
    // $query = $this->db->query("delete from trskpd_rancang where kd_skpd='$skpd' and kd_kegiatan1='$reklama'");
    // $query = $this->db->query("insert into trskpd_rancang(kd_gabungan,kd_kegiatan,kd_program,kd_urusan,kd_skpd,kd_kegiatan1,kd_program1,jns_kegiatan,nm_skpd,nm_kegiatan,nm_program,lanjut) 
    ...
    function status_giat($status='',$kegiatan) {
        ...
        $query = $this->db->query("UPDATE trskpd_rancang set status_sub_kegiatan='$status' where kd_sub_kegiatan='$kegiatan'");
      ...
      function tambah_giat_penyusunan()
       ...
       function skpd() {
         ...
         function ghapus_rancang($skpd='',$kegiatan='') {
            $query = $this->db->query("delete from trskpd where kd_skpd='$skpd' and kd_sub_kegiatan='$kegiatan' and  kd_sub_kegiatan not in(SELECT DISTINCT kd_kegiatan FROM trdrka_rancang) ");
            
                    if (($query)){
                    $query1 = $this->db->query("delete from trskpd_rancang where kd_skpd='$skpd' and kd_sub_kegiatan='$kegiatan' and  kd_sub_kegiatan not in(SELECT DISTINCT kd_sub_kegiatan FROM trdrka)  ");
                    }
    ...
    function preview_pendapatan_penyusunan(){
            ...
            $cRet .="<table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"left\" border=\"1\">
                        <tr>
                            <td width=\"20%\">Organisasi </td>
                            <td width=\"80%\">".substr($kd_skpd_90,0,(strlen($kd_skpd_90)-3))." -".$this->rka_model->get_nama($kd_org,'nm_org','ms_organisasi','kd_org')."</td>
                        </tr>
                        <tr>
