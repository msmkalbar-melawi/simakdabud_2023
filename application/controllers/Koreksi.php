      ...
      //  $query1 = $this->tukd_model->qangg_sdana($tgl,$skpd,$giat,$kdrek5);
        ...
        if ($jnsbeban=='1'){
            $sql ="SELECT * from (
                     ...
                     a.kd_sub_kegiatan='$giat' and a.kd_rek6='$kdrek5' and a.kd_skpd='$skpd'
                     union ALL
                     ...
                     a.kd_sub_kegiatan='$giat' and a.kd_rek6='$kdrek5' and a.kd_skpd='$skpd' and nsumber2_ubah <> 0
                     )z"; 
        }else{
                $sql ="SELECT b.sumber as sumber_dana,sum(b.nilai)as nilai,sum(b.nilai)as nilai_sempurna,sum(b.nilai)as nilai_ubah from trhspp a inner join trdspp b 
        ...
        foreach ($query1->result_array() as $resulte) {
            ...
            $result[] = array(
                ...
                'anggaran' => number_format($resulte['nilai'],2,'.',','),
                'anggaran_semp' => number_format($resulte['nilai_sempurna'],2,'.',','),
                'anggaran_ubah' => number_format($resulte['nilai_ubah'],2,'.',','),
                'kegiatan' => $giat,
                'kd_rek6' => $kdrek5
                );
                $ii++;    
