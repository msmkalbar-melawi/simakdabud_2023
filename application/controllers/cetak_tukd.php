...
class cetak_tukd extends CI_Controller
{
    ...
    union
      ...
      where month(tgl)<='$bulan' and kode='$lcskpd') a 
        ...
        $nippa = str_replace('123456789', ' ', $_GET['ttd']);
        ...
        $trh2 = $hasil->row();
        $nipbk = str_replace('123456789', ' ', $_GET['ttd2']);
        $csql = "SELECT nip as nip_bk,nama as nm_bk,jabatan,pangkat FROM ms_ttd WHERE nip = '$nipbk' AND left(kd_skpd,17) = '$lcskpdd' AND (kode='BK' OR kode='PA')";
        $hasil3 = $this->db->query($csql);
        $trh3 = $hasil3->row();
        $csql = "SELECT nm_skpd FROM ms_skpd WHERE kd_skpd = '$lcskpd' ";
        $hasil4 = $this->db->query($csql);
        $trh4 = $hasil4->row();
        $nipbpp = str_replace('123456789', ' ', $_GET['ttd3']);
        ...
        $cRet .= "<table style=\"border-collapse:collapse;font-family: Times New Roman; font-size:12px\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
                    <tr>
                        ...
                        <tr>
                        <td align=\"left\" style=\"font-size:14px\" >&nbsp;&nbsp;&nbsp;&nbsp;<strong>TAHUN ANGGARAN 2023</strong></td></tr>
                        <tr>
