<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    function select_rka_penetapan($kegiatan='', $skpd='') {


            $sql = "SELECT a.kd_rek6,b.nm_rek6,a.nilai,a.nilai_sempurna,a.nilai_ubah,a.sumber,
            (select g.nm_sumberdana from hsumber_dana g where a.sumber=g.kd_sumberdana)as nmsumber,
            a.sumber2,
            (select g.nm_sumberdana from hsumber_dana g where a.sumber2=g.kd_sumberdana)as nmsumber2,
            a.sumber3,
            (select g.nm_sumberdana from hsumber_dana g where a.sumber3=g.kd_sumberdana)as nmsumber3,
            a.sumber4,
            (select g.nm_sumberdana from hsumber_dana g where a.sumber4=g.kd_sumberdana)as nmsumber4,
            a.nilai_sumber,a.nilai_sumber2
                    ...
                    not in ('5101') */
GROUP BY a.kd_rek6,b.nm_rek6,a.nilai,a.nilai_sempurna,a.nilai_ubah,a.sumber,a.sumber2,a.sumber3,a.sumber4,a.nilai_sumber,a.nilai_sumber2
,a.nilai_sumber3,a.nilai_sumber4
                    order by a.kd_rek6 ";                   
     ...
     function ambil_sdana(){
            ...
            $query1 = $this->db->query("SELECT a.kd_sumberdana,a.nm_sumberdana,(nilai+nilaisilpa) -
                                        ...
                                        where sumber=a.kd_sumberdana and left(kd_rek6,1) <> '4' and left(kd_rek6,2) <>'61' /*and left(kd_rek6,4) <>'5101'*/)+
                                        (select isnull(sum(nilai_sumber2),0)as m from trdrka 
                                        where sumber2=a.kd_sumberdana and left(kd_rek6,1) <> '4' and left(kd_rek6,2) <>'61' /*and left(kd_rek6,4) <>'5101'*/)+
                                        (select isnull(sum(nilai_sumber3),0)as n from trdrka 
                                        where sumber3=a.kd_sumberdana and left(kd_rek6,1) <> '4' and left(kd_rek6,2) <>'61' /*and left(kd_rek6,4) <>'5101'*/)+
                                        (select isnull(sum(nilai_sumber4),0)as v from trdrka 
                                        where sumber4=a.kd_sumberdana and left(kd_rek6,1) <> '4' and left(kd_rek6,2) <>'61' /*and left(kd_rek6,4) <>'5101'*/) )as sisa
...
SUBSTRING(a.no_trdrka,24,15)='$sub' GROUP BY RIGHT(a.no_trdrka,12),b.header, b.id,b.uraian)z WHERE header='1' 
    ...
    $sqltpk="SELECT SUM(nilai) AS totb FROM trdrka WHERE LEFT(kd_rek6,2)='62' and left(kd_skpd,17)='$id'";
        ...
        function urusan1(){
            ...
            function select_giat_penetapan($skpd='', $anggaran='') {  
                // $data = $this->cek_anggaran_model->cek_anggaran($skpd);  
            $sql = "select a.kd_sub_kegiatan as kd_kegiatan,b.nm_sub_kegiatan,a.jns_kegiatan,a.lanjut,status_sub_kegiatan from trskpd a inner join ms_sub_kegiatan b on b.kd_sub_kegiatan=a.kd_sub_kegiatan where a.kd_skpd='$skpd' AND a.jns_ang='$anggaran' order by a.kd_sub_kegiatan";
            $query1 = $this->db->query($sql);  
            $result = array();
            $ii = 0;
            foreach($query1->result_array() as $resulte)
       ...
       //  }
        ...
        function status_giat($status='',$kegiatan, $skpd='', $anggaran='') {
            // echo($status);
        // $data = $this->cek_anggaran_model->cek_anggaran($skpd);
        $query = $this->db->query("UPDATE trskpd set status_sub_kegiatan='$status' where jns_ang='$anggaran' and kd_sub_kegiatan='$kegiatan' AND kd_skpd='$skpd'");
        ...
        function ghapus_penetapan($skpd='',$kegiatan='', $anggaran='') {
            $query = $this->db->query("delete from trskpd where kd_skpd='$skpd' and kd_sub_kegiatan='$kegiatan' AND jns_ang='$anggaran' and  kd_kegiatan not in(SELECT DISTINCT kd_kegiatan FROM trdrka)  ");
            $this->select_giat_penetapan($skpd);
        }
        ...
        function ld_giat_penetapan($skpd='',$urusan='') { 
                        ...
                        $data = $this->cek_anggaran_model->cek_anggaran($skpd);
                            ...
                            like '%$lccr%' or nm_sub_kegiatan like '%$lccr%') and kd_sub_kegiatan not in(select kd_sub_kegiatan 
                            from trskpd where kd_skpd='$skpd' and jns_ang='$data') order by kd_sub_kegiatan  ";
...
function preview_angg_selisih($id,$csangg){
   ...
   function select_rka_pend_akt($kegiatan='',$skpd='') {
    ...
    function pgiat_pend($cskpd='') {
        ...
        $lccr = $this->input->post('q');
        $sql  = "SELECT a.kd_sub_kegiatan,b.nm_sub_kegiatan,a.jns_sub_kegiatan FROM trskpd a INNER JOIN ms_sub_kegiatan b ON a.kd_sub_kegiatan=b.kd_sub_kegiatan
                 where a.kd_skpd='$cskpd' and a.jns_ang='$data' and ( upper(a.kd_sub_kegiatan) like upper('%$lccr%') or upper(a.nm_sub_kegiatan) like upper('%$lccr%') )";
