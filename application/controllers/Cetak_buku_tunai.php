...
function index()
    ...
    function cetak_kas_tunai(){
			...
			$tgl_ttd= $this->uri->segment(7);
         
			$ttd1 = str_replace('%20', ' ', $this->uri->segment(8));
			$ttd2 = str_replace('%20', ' ',  $this->uri->segment(9));
		    $csql="SELECT a.nama, a.nip,a.jabatan,a.pangkat FROM ms_ttd a WHERE a.kd_skpd = '$kd_skpd' and nip='$ttd1'";
			...
			$csql="SELECT a.nama, a.nip,a.jabatan,a.pangkat FROM ms_ttd a WHERE a.kd_skpd = '$kd_skpd' and nip='$ttd2'";
			$hasil = $this->db->query($csql);
			$trh2 = $hasil->row();          
			$lcNmPA = $trh2->nama;
			$lcNipPA = $trh2->nip; 			
