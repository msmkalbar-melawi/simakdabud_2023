...
class cetak_spj extends CI_Controller
{
    ...
    function spj_melawi($lcskpd = '', $nbulan = '', $ttd1 = '', $tgl_ctk = '', $ttd2 = '', $ctk = '', $atas = '', $bawah = '', $kiri = '', $kanan = '', $jenis = '', $jns_bp, $jns_ang = '')
    {
        ...
        if ($jns_bp == "bk") {
            $sqlttd1 = "SELECT nama as nm,nip as nip,jabatan as jab, pangkat FROM ms_ttd where kd_skpd='$lcskpdd' and kode IN('BK','PA') and nip='$ttd1'";
        } else {
            $sqlttd1 = "SELECT nama as nm,nip as nip,jabatan as jab, pangkat FROM ms_ttd where kd_skpd='$lcskpd' and kode='BPP' and nip='$ttd1'";
            $lcskpdd = $lcskpdd;
        }
    ...
    function spj_lama_beud($lcskpd = '', $nbulan = '', $ttd1 = '', $tgl_ctk = '', $ttd2 = '', $ctk = '', $atas = '', $bawah = '', $kiri = '', $kanan = '', $jenis = '', $jns_bp, $jns_ang = '')
    {
        ...
        $sqlanggaran1 = "SELECT case when status=1 and status_sempurna=1 and status_ubah=1 and $nbulan>=month(tgl_dpa_ubah) then 'nilai_ubah' 
					   when status=1 and status_sempurna=1 and status_ubah=1 and $nbulan>=month(tgl_dpa_sempurna) and $nbulan<month(tgl_dpa_ubah) then 'nilai_akhir_sempurna'
					   when status=1 and status_sempurna=1 and status_ubah=1 and $nbulan<month(tgl_dpa_sempurna) then 'nilai'
					   when status=1 and status_sempurna=1 and status_ubah=0 and $nbulan>=month(tgl_dpa_sempurna) then 'nilai_akhir_sempurna' 
					   when status=1 and status_sempurna=1 and status_ubah=0 and $nbulan<month(tgl_dpa_sempurna) then 'nilai'
					   when status=1 and status_sempurna=0 and status_ubah=0 and $nbulan>=month(tgl_dpa) then 'nilai'
...
and kd_skpd='$lcskpd'";
    ...
    function cetak_spj_priode($lcskpd = '', $ntgl1 = '', $ntgl2 = '', $ttd1 = '', $tgl_ctk = '', $ttd2 = '', $ctk = '', $atas = '', $bawah = '', $kiri = '', $kanan = '', $jenis = '', $jns_bp, $jns_ang = '')
    {
        ...
        $cRet .= "
            ...
            <tr>
            <td align=\"left\" style=\"font-size:14px\" ><strong>TAHUN ANGGARAN 2022</strong>
            </td>
            </tr>
            <tr>
    ...
    and kd_skpd='$lcskpd'";
        ...
        $tox_awal = "SELECT isnull(sld_awal,0) AS jumlah FROM ms_skpd where kd_skpd='$lcskpd' and '2017-01-01'>='$ntgl1' and '2017-01-31'<='$ntgl2'";
        $hasil = $this->db->query($tox_awal);
        $tox_ini = $hasil->row('jumlah');
        //          echo  $tox_ini;            
        $tox_ini = (empty($tox_ini) ? 0 : $tox_ini);

        $tox_awal = "SELECT isnull(sld_awal,0) AS jumlah FROM ms_skpd where kd_skpd='$lcskpd' and '2017-01-31'<'$ntgl1'";
        $hasil = $this->db->query($tox_awal);
        $tox_ll = $hasil->row('jumlah');
        $tox_ll = (empty($tox_ll) ? 0 : $tox_ll);
