...
--                         SELECT satuan_sempurna1 from trdpo group by satuan_sempurna1
    ...
    function q_lamp1_sdana_new($id, $sumber, $sumber2, $sumber3, $sumber4, $nilai_sumber, $nilai_sumber2, $nilai_sumber3, $nilai_sumber4, $notin, $where)
    {
        $hasil = '';
        $sql1 = "SELECT kd_rek,rek,nm_rek,sum(pad) [pad],sum(DAK) [dak],sum(DAKNF) [daknf],sum(DAU) [dau],sum(DBHP) [dbhp],sum(did) [did],sum(lain2) [lain2] from(
                    ...
                    sum (CASE WHEN $sumber in ('11','111','11415','21','21102') THEN $nilai_sumber ELSE 0 END) AS PAD,
                    SUM (CASE WHEN $sumber in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '221010320',
                '221010326',
                '221010352') THEN $nilai_sumber ELSE 0 END) AS DAK,
                                    SUM (CASE WHEN $sumber in ('2210104',
                '221010401',
                '221010402',
                '221010403',
                '221010410',
                ...
                '221010417',
                '221010418',
                '221010420') THEN $nilai_sumber ELSE 0 END) AS DAKNF,
                                    SUM (CASE WHEN $sumber in ('1210102','2210102') THEN $nilai_sumber ELSE 0 END) AS DAU,
                                    SUM (CASE WHEN $sumber = 'DBHP' THEN $nilai_sumber ELSE 0 END) AS DBHP,
                                    SUM (CASE WHEN $sumber = 'DID' THEN $nilai_sumber ELSE 0 END) AS DID,
                                    SUM (CASE WHEN $sumber not in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '221010420',
                '1210102','2210102',
                '1210101','221010101','221010102'
                ) THEN $nilai_sumber ELSE 0 END) AS Lain2
                                    FROM ms_rek1 a INNER JOIN trdrka b
                                    ON a.kd_rek1=LEFT(b.kd_rek6,(LEN(a.kd_rek1))) where left(a.kd_rek1,1)='$id' $where GROUP BY a.kd_rek1,a.lra, a.nm_rek1
                                    UNION ALL 
                ...
                '1210101','221010101','221010102'
                                    ...
                                    ON a.kd_rek2=LEFT(b.kd_rek6,(LEN(a.kd_rek2))) where left(a.kd_rek2,1)='$id' $where GROUP BY a.kd_rek2,a.lra,a.nm_rek2 
                                    UNION ALL 
                ...
                '1210101','221010101','221010102'
                                    ...
                                    ON a.kd_rek3=LEFT(b.kd_rek6,(LEN(a.kd_rek3))) where left(a.kd_rek3,1)='$id' $where GROUP BY a.kd_rek3,a.lra, a.nm_rek3 
                                    UNION ALL 
                                    --------------------sumber2--------------------------
                                    SELECT a.kd_rek1 AS kd_rek,rtrim(a.lra) AS rek, a.nm_rek1 AS nm_rek ,
                                    sum (CASE WHEN $sumber2 in ('11','111','11415','21','21102') THEN $nilai_sumber2 ELSE 0 END) AS PAD,
                                    SUM (CASE WHEN $sumber2 in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '221010320',
                '221010326',
                '221010352') THEN $nilai_sumber2 ELSE 0 END) AS DAK,
                                    SUM (CASE WHEN $sumber2 in ('2210104',
                '221010401',
                '221010402',
                '221010403',
                '221010410',
                ...
                '221010417',
                '221010418',
                '221010420') THEN $nilai_sumber2 ELSE 0 END) AS DAKNF,
                                    SUM (CASE WHEN $sumber2 in ('1210102','2210102') THEN $nilai_sumber2 ELSE 0 END) AS DAU,
                                    SUM (CASE WHEN $sumber2 = 'DBHP' THEN $nilai_sumber2 ELSE 0 END) AS DBHP,
                                    SUM (CASE WHEN $sumber2 = 'DID' THEN $nilai_sumber2 ELSE 0 END) AS DID,
                                    SUM (CASE WHEN $sumber2 not in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '1210102','2210102',
                '1210101','221010101','221010102'
                ) THEN $nilai_sumber2 ELSE 0 END) AS Lain2
                                    FROM ms_rek1 a INNER JOIN trdrka b
                                    ON a.kd_rek1=LEFT(b.kd_rek6,(LEN(a.kd_rek1))) where left(a.kd_rek1,1)='$id' $where GROUP BY a.kd_rek1,a.lra, a.nm_rek1
                                    UNION ALL 
                                    SELECT a.kd_rek2 AS kd_rek,rtrim(a.lra) AS rek,a.nm_rek2 AS nm_rek ,
                ...
                '1210101','221010101','221010102'
                                    ...
                                    ------------------------sumber3-------------------
                                    SELECT a.kd_rek1 AS kd_rek,rtrim(a.lra) AS rek, a.nm_rek1 AS nm_rek ,
                                    sum (CASE WHEN $sumber3 in ('11','111','11415','21','21102') THEN $nilai_sumber3 ELSE 0 END) AS PAD,
                                    SUM (CASE WHEN $sumber3 in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '221010320',
                '221010326',
                '221010352') THEN $nilai_sumber3 ELSE 0 END) AS DAK,
                                    SUM (CASE WHEN $sumber3 in ('2210104',
                '221010401',
                '221010402',
                '221010403',
                '221010410',
                ...
                '221010417',
                '221010418',
                '221010420') THEN $nilai_sumber3 ELSE 0 END) AS DAKNF,
                                    SUM (CASE WHEN $sumber3 in ('1210102','2210102') THEN $nilai_sumber3 ELSE 0 END) AS DAU,
                                    SUM (CASE WHEN $sumber3 = 'DBHP' THEN $nilai_sumber3 ELSE 0 END) AS DBHP,
                                    SUM (CASE WHEN $sumber3 = 'DID' THEN $nilai_sumber3 ELSE 0 END) AS DID,
                                    SUM (CASE WHEN $sumber3 not in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '1210102','2210102',
                '1210101','221010101','221010102'
                ) THEN $nilai_sumber3 ELSE 0 END) AS Lain2
                                    FROM ms_rek1 a INNER JOIN trdrka b
                                    ON a.kd_rek1=LEFT(b.kd_rek6,(LEN(a.kd_rek1))) where left(a.kd_rek1,1)='$id' $where GROUP BY a.kd_rek1,a.lra, a.nm_rek1
                                    UNION ALL 
                                    SELECT a.kd_rek2 AS kd_rek,rtrim(a.lra) AS rek,a.nm_rek2 AS nm_rek ,
                ...
                '1210101','221010101','221010102'
                                    ...
                                    ----------------------sumber4-------------------------
                                    SELECT a.kd_rek1 AS kd_rek,rtrim(a.lra) AS rek, a.nm_rek1 AS nm_rek ,
                                    sum (CASE WHEN $sumber4 in ('11','111','11415','21','21102') THEN $nilai_sumber4 ELSE 0 END) AS PAD,
                                    SUM (CASE WHEN $sumber4 in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '221010320',
                '221010326',
                '221010352') THEN $nilai_sumber4 ELSE 0 END) AS DAK,
                                    SUM (CASE WHEN $sumber4 in ('2210104',
                '221010401',
                '221010402',
                '221010403',
                '221010410',
                ...
                '221010417',
                '221010418',
                '221010420') THEN $nilai_sumber4 ELSE 0 END) AS DAKNF,
                                    SUM (CASE WHEN $sumber4 in ('1210102','2210102') THEN $nilai_sumber4 ELSE 0 END) AS DAU,
                                    SUM (CASE WHEN $sumber4 = 'DBHP' THEN $nilai_sumber4 ELSE 0 END) AS DBHP,
                                    SUM (CASE WHEN $sumber4 = 'DID' THEN $nilai_sumber4 ELSE 0 END) AS DID,
                                    SUM (CASE WHEN $sumber4 not in ('2210103',
                '221010303',
                '221010304',
                '221010305',
                '221010306',
                ...
                '1210102','2210102',
                '1210101','221010101','221010102'
                ) THEN $nilai_sumber4 ELSE 0 END) AS Lain2
                                    FROM ms_rek1 a INNER JOIN trdrka b
                                    ON a.kd_rek1=LEFT(b.kd_rek6,(LEN(a.kd_rek1))) where left(a.kd_rek1,1)='$id' $where GROUP BY a.kd_rek1,a.lra, a.nm_rek1
                                    UNION ALL 
                                    SELECT a.kd_rek2 AS kd_rek,rtrim(a.lra) AS rek,a.nm_rek2 AS nm_rek ,
    ...
    function q_sumberdananew($field, $sumber, $sumber2, $sumber3, $sumber4, $nilai_sumber, $nilai_sumber2, $nilai_sumber3, $nilai_sumber4, $where, $group)
    {
        $hasil = '';
        $sql = "select kode,nama,sum(pad) [pad],sum(DAK) [dak],sum(DAKNF) [daknf],sum(DAU) [dau],sum(DBHP) [dbhp],sum(did) [did],sum(lain2) [lain2] from(
                    select $field SUM (CASE WHEN $sumber in ('11','111','11415','21','21102') THEN $nilai_sumber ELSE 0 END) AS PAD,
                    SUM (CASE WHEN $sumber in ('2210103',
                    '221010303',
                    '221010304',
                    '221010305',
                    ...
                    '221010420') THEN $nilai_sumber ELSE 0 END) AS DAKNF,
                    SUM (CASE WHEN $sumber in ('1210102','2210102') THEN $nilai_sumber ELSE 0 END) AS DAU,
                    SUM (CASE WHEN $sumber in ('1210101','221010101','221010102') THEN $nilai_sumber ELSE 0 END) AS DBHP,
                    SUM (CASE WHEN $sumber = 'DID' THEN $nilai_sumber ELSE 0 END) AS DID,
                    SUM (CASE WHEN $sumber not in ('2210103',
                    '221010303',
                    '221010304',
                    ...
                    from trdrka $where group by $group
                    union all
                    select $field SUM (CASE WHEN $sumber2 in ('11','111','11415','21','21102') THEN $nilai_sumber2 ELSE 0 END) AS PAD,
                    SUM (CASE WHEN $sumber2 in ('2210103',
                    '221010303',
                    '221010304',
                    '221010305',
                    ...
                    from trdrka $where group by $group
                    union all
                    select $field SUM (CASE WHEN $sumber3 in ('11','111','11415','21','21102') THEN $nilai_sumber3 ELSE 0 END) AS PAD,
                    SUM (CASE WHEN $sumber3 in ('2210103',
                    '221010303',
                    '221010304',
                    '221010305',
                    ...
                    from trdrka $where group by $group
                    union all
                    select $field SUM (CASE WHEN $sumber4 in ('11','111','11415','21','21102') THEN $nilai_sumber4 ELSE 0 END) AS PAD,
                    SUM (CASE WHEN $sumber4 in ('2210103',
                    '221010303',
                    '221010304',
                    '221010305',
    ...
    {
        $kode = $skpd;
        $ang = $this->cek_anggaran_model->cek_anggaran($kode);
        $hasil  = 0;
        $csql = "SELECT * from(
                        select a.kd_skpd,a.kd_sub_kegiatan,a.ang,isnull(b.kas,0) kas from(
                            select kd_skpd,kd_sub_kegiatan,sum(nilai) [ang] from trdrka where kd_skpd='$skpd' and jns_ang='$ang'
                            group by kd_skpd,kd_sub_kegiatan
                        )as a left join (
                            select kd_skpd,kd_sub_kegiatan,sum($angg) [kas] from trdskpd_ro where kd_skpd='$skpd'
                            group by kd_skpd,kd_sub_kegiatan
    ...
    function _mpdf_folio_sp2d($judul = '', $isi = '', $lMargin = 10, $rMargin = 10, $font = '', $orientasi = '', $hal = '', $fonsize = '')
    {
